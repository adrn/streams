...
def test_particlecollection_init():
    ...
    with pytest.raises(ValueError):
        pc = ParticleCollection(r=r, v=v, m=m, units=[u.kpc, u.Myr, u.M_sun])
    ...
    with pytest.raises(ValueError): pc = ParticleCollection(r=r, v=v, units=[u.kpc, u.Myr, u.M_sun])
    with pytest.raises(ValueError): pc = ParticleCollection(r=r, m=m, units=[u.kpc, u.Myr, u.M_sun])
    with pytest.raises(ValueError): pc = ParticleCollection(v=v, m=m, units=[u.kpc, u.Myr, u.M_sun])
