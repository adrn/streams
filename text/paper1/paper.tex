...
times). Distance measurements of Blue Horizontal Branch and Blue Straggler stars at these distances in the halo typically achieve 15-25\% uncertainties. [can cite Alis Deason if necessary].
...
over the 5-year lifetime of the mission, Gaia will
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=1.\textwidth, trim=2 2 5 5, clip]{/Users/adrian/projects/streams/plots/paper1/gaia.pdf}
...
\end{equation}
where $C_1$, $C_2$, and $C_3$ are combinations of the $x$ and $y$ flattening ($q_1$, $q_2$) and orientation of the halo with respect to the baryonic disk ($\phi$):
\begin{align}
...
functional form for the potential, $\Phi$. For a
