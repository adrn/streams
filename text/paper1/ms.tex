...
\begin{figure}[h!]
\begin{center}
%\includegraphics[width=0.45\textwidth]{/Users/adrian/projects/streams/plots/paper1/gaia.eps}
...
and the potential in which it orbits. (Note, new observational work by 
...
\begin{figure}[h]
\begin{center}
%\includegraphics[width=0.45\textwidth]{/Users/adrian/projects/streams/plots/paper1/lm10.eps}
...
halo through the constraints on the potential parameters $v_{\rm halo}$, $q_1$, $q_z$, and $\phi$. Combined {\it Spitzer} and {\it Gaia} measurements of distances and proper motions
...
\begin{figure}[h]
\begin{center}
%\includegraphics[width=0.47\textwidth,trim=5 0 0 0, clip]{/Users/adrian/projects/streams/plots/paper1/ps_distance.eps}
...
the star is likely recaptured by the satellite (in the absence of errors,
 ...
 imposed a similar condition as a hard boundary and used the number 
of recaptured particles in a given backwards-integration as a cost 
...
\begin{figure}[h]
\begin{center}
%\includegraphics[width=0.45\textwidth]{/Users/adrian/projects/streams/plots/paper1/objective_function.eps}
...
\begin{figure*}[ht!]
%\centering\includegraphics[width=0.9\textwidth,trim=0 0 0 0, clip]{/Users/adrian/projects/streams/plots/paper1/bootstrap.eps}
...
of the satellite itself. Preliminary simulations (to be fully explored in 
forthcoming work) suggest that these first two points can be neglected 
...
\citep[for example, the Orphan Stream;][]{belokurov07}. 
