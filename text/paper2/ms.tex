...
\begin{align}
	...
	\hat{\bs{x}}_3 &= \hat{\bs{L}} = \frac{\bs{r}_p \times \bs{v}_p}{\|\bs{r}_p \times \bs{v}_p\|}\label{eq:x3}.
\end{align}
...
Most of the streams and debris structures discovered thus far have undetected or unconfirmed progenitors. [...]
