...
\end{multline}
Here we assume that the ``shocked'' distribution has a much larger variance, and arbitrarily set this to 10 times the variance of the stripped debris. The full posterior probability for the position of a star, progenitor, and properties of the parent potential, given the data, is then
\begin{multline}
...
We first test the model on small samples of stars sampled from the simulations above assuming perfect observational data. 
