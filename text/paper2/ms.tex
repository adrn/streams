...
\altaffiltext{\adrn}{To whom correspondence should be addressed: \email{adrn@astro.columbia.edu}}
...
\begin{abstract}
Context: Connecting cosmological simulations to observed galaxies is difficult because baryonic processes not well understood/modeled but also because they are gravitationally dominated by unobservable dark matter. One powerful measure is the shape of the potential -- triaxial, density profile, etc. Tidal streams are excellent tracers of mass.

Aims: Present a method for inferring higher order properties of the Galactic potential using debris from disrupted satellites.

Methods: 

Results: Can simultaneously constrain properties of progenitor, missing dimensions, and potential with a simple model for disrupted debris in phase-space. The method works well with small numbers of stars and with finite or large observational uncertainties or missing dimensions and generalizes naturally to multiple independent debris structures.
