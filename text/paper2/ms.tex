...
% Generate approx. to N-body -> single Orbit --> Orbits + offsets --> Bovy
% method, problem, etc. then address what we fix

- Broader comparison to other methods\\
\indent\indent- 'generative methods' more generally (ie N-body, Bovy, plus Varghese, plus Kuepper plus new possible action-angle models....\\
\indent\indent- Sanders \& Binney 2013\\
\indent\indent- statistical methods, Penarrubia, Sanderson, Rewinder\\
