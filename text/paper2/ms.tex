...
\begin{align}
	...
	p(\bs{r} \given \bs{r}_\sat, m, \dot{m}, \tub, \Phi, \Loffset, \tailbit) &= \mathcal{N}(\bs{r} \given \bs{r}_\sat - \Loffset\,\tailbit\,\rtide\,\hat{x}_1, \rtide^2)_{t=\tub}\\
...
\begin{multline}
	p(\Phi, \{\W^{(i)}\}, \W_\sat, \tub, \Loffset, \tailbit, \given \{\D^{(i)}\}, \D_\sat) = \\
...
\end{multline}
This model works well when all stars are lost due to tidal pruning. Even on a mildly eccentric orbit, stars become preferentially unbound around the satellite's pericenter because of tidal shocking \citep[e.g.,][]{choi09}. We will explore properly modeling this process in future work. 
