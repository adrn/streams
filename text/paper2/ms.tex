...
The above scalings motivate a model for tidal debris in which stars were ``released'' at the instantaneous, effective Lagrange points with some dispersion in position and velocity, all of which depend only on the mass of the progenitor, the parent potential properties, and the orbit of the progenitor. We present this model in detail below.
...
\end{align}
\begin{multline}
	p(\W \given \W_\sat, \tub, \Phi, \tailbit, c, \pshock) = \\
...
\begin{multline}
	p(\Phi, \W, \W_\sat, \tub, \tailbit, c, \pshock \given \D, \D_\sat) = \\
