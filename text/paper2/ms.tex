...
\begin{abstract}
Context: Connecting cosmological simulations to observed galaxies is difficult because baryonic processes not well understood/modeled but also because they are gravitationally dominated by unobservable dark matter. 
Aims: Develop a method for inferring higher order properties of the Galactic potential using debris from disrupted satellites.
Methods: 
Results: 
Conclusions: 
