...
These results are are encouraging for the eventual goal to use more flexible, time-dependent potential models.
...
KVJ thanks the Institute of Astronomy at the University of Cambridge for hospitality.
