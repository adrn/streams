...
\begin{align}
	p_{\rm strip} &= \left [ \mathcal{N}(\bs{r} \given \bs{r}_\sat - cK\rtide \hat{x}_1, \sigma_r)\mathcal{N}(\bs{v} \given \bs{v}_\sat, \sigma_v) \left\vert\J\right\vert\right]_{t=\tub}\\
	p_{\rm shock} &= \left [ \mathcal{N}(\bs{r} \given \bs{r}_\sat, 3\sigma_r)\mathcal{N}(\bs{v} \given \bs{v}_\sat, 3\sigma_v) \left\vert\J\right\vert\right]_{t=\tub}\\
	p(\W \given \W_\sat, \tub, \Phi, K, c, P_{\rm shock}) &= P_{\rm shock}p_{\rm shock} + (1-P_{\rm shock})p_{\rm strip}
\end{align}
