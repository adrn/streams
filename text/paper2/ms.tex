...
\begin{center}
	\begin{tabular}{l c l} \toprule
		...
		tail assignment (binary) & $\beta$ & $\pm1$~equally likely (fixed at truth)\\ % TODO: how to say equal weight to -1 or 1?
		time unbound & $\tub$ & $\mathcal{U}(0,6.2)~Gyr$\\ % TODO: talk about \tint (integration time) in text!
		\bottomrule
		\end{tabular}
