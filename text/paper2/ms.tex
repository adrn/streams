...
[TODO: A historical introduction to dark matter, potential measures?]

Major open questions in near-field cosmology: (1) is the Milky Way potential triaxial and if so, how much? (2) How does the potential vary with radius? (3) Is there graininess to the potential? e.g., is there substructure?

Cosmological simulations of galaxy formation in the $\Lambda$CDM paradigm seem to produce triaxial dark matter halos \citep{dubinski91, jing02, kuhlen07, veraciro11}. Halos tend to be more strongly triaxial in dark-matter-only simulations, but still present with the inclusion of baryons. Baryonic processes tend to modify the dark matter structure in the inner galaxy, leading possibly to radially-dependent axis ratios and halo orientation. [statements about integrability]. [if want to connect lambda-CDM to the milky way, we need to face non-integrable potentials]

[something about measuring halo shape with lensing]. 

[why use tidal streams?] \cite{lm10} used N-body models to ... triaxial.
