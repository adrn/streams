    ...
    if not os.path.exists(cached_data_file):
        ...
        for param in ['q1','qz','v_halo','phi']:
            ...
            for stat in stats:
                ...
                params[param] = stat
                lm10 = LawMajewski2010(n_particles=particles.nparticles, **params)
...
def variance_projections():
    ...
    correct_lm10 = LawMajewski2010(n_particles=particles.nparticles, **true_params)
    wrong_lm10 = LawMajewski2010(n_particles=particles.nparticles, **params)
...
def phase_space_d_vs_time(N=10):
    ...
    true_potential = LawMajewski2010(n_particles=particles.nparticles, **true_params)
    wrong_potential = LawMajewski2010(n_particles=particles.nparticles, **wrong_params)
